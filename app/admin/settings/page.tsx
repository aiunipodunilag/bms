...
export default function AdminSettingsPage() {
  ...
  const handleSaveSchedule = async () => {
    ...
    // TODO: PUT /api/admin/settings/schedule with schedule data
  ...
  const handleSaveSettings = async () => {
    ...
    // TODO: PUT /api/admin/settings/booking with settings data
    await new Promise((r) => setTimeout(r, 900));
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setSettings({ ...settings, maxAdvanceDays: parseInt(e.target.value) || 1 })
                  }
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setSettings({
                      ...settings,
                      noShowGracePeriodMinutes: parseInt(e.target.value) || 5,
                    })
                  }
                  className="w-full px-3 py-2.5 rounded-xl border border-gray-300 text-sm focus:outline-none focus:ring-2 focus:ring-brand-500"
                />
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setSettings({ ...settings, groupMinMembers: parseInt(e.target.value) || 2 })
                  }
                  className="w-full px-3 py-2.5 rounded-xl border border-gray-300 text-sm focus:outline-none focus:ring-2 focus:ring-brand-500"
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setSettings({ ...settings, groupMaxHours: parseInt(e.target.value) || 1 })
                  }
                  className="w-full px-3 py-2.5 rounded-xl border border-gray-300 text-sm focus:outline-none focus:ring-2 focus:ring-brand-500"
                />
              </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setSettings({
                        ...settings,
                        extraIndividualFeeNGN: parseInt(e.target.value) || 0,
                      })
                    }
                    className="w-full px-3 py-2.5 rounded-xl border border-gray-300 text-sm focus:outline-none focus:ring-2 focus:ring-brand-500"
                  />
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setSettings({
                        ...settings,
                        externalCoworkingFeeNGN: parseInt(e.target.value) || 0,
                      })
                    }
                    className="w-full px-3 py-2.5 rounded-xl border border-gray-300 text-sm focus:outline-none focus:ring-2 focus:ring-brand-500"
                  />
              ...
              <div className="flex items-center justify-between p-3 rounded-xl border border-gray-200 bg-gray-50">
                ...
                <button
                  ...
                  className={`transition-colors ${
                    settings.maintenanceMode ? "text-red-500" : "text-gray-300"
                  }`}
                >
                  {settings.maintenanceMode ? (
                    <ToggleRight size={24} />
              ...
              <div className="flex items-center justify-between p-3 rounded-xl border border-gray-200 bg-gray-50">
                ...
                <button
                  onClick={() =>
                    setSettings({
                      ...settings,
                      requireJustificationForPremium: !settings.requireJustificationForPremium,
                    })
                  }
                  className={`transition-colors ${
                    settings.requireJustificationForPremium ? "text-brand-600" : "text-gray-300"
                  }`}
                >
                  {settings.requireJustificationForPremium ? (
                    <ToggleRight size={24} />
                  ) : (
                    <ToggleLeft size={24} />
                  )}
