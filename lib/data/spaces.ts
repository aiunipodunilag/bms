...
// All internal tiers (everyone except external users).
// Use this for spaces that regular students and staff can book but external users cannot.
const INTERNAL_TIERS: UserTier[] = [
  "regular_student",
  "lecturer_staff",
  "product_developer",
  "volunteer_space_lead",
